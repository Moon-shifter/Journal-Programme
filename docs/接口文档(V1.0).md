...
最后更新：12.18 **说明：完善基本信息,请依靠ai快速了解不了解的概念**
...
- 教师表：自增主键为teacher_id，从1000开始 status默认inactive(同管理员)
